...
@NamedStoredProcedureQuery(
        name = "Notas.spInsertNotas",
        procedureName = "sp_insertNotas",
        parameters = {
...
public class Notas implements Serializable {
    ...
    public Avaliacao getCodigoAvaliacao() { return codigoAvaliacao; }
    public void setCodigoAvaliacao(Avaliacao codigoAvaliacao) { this.codigoAvaliacao = codigoAvaliacao; }
